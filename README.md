...
The live mobile dashboard showing battery, HVAC, weather, security, garage, lighting, and Marvin's status layer in one view.

<img width="1290" height="2601" alt="Marvin Home dashboard" src="https://github.com/user-attachments/assets/0102b0c4-b62d-49b8-924d-821ac11725a1" />

### Control and decision logic

The live director view showing active/recommended modes, energy margin, projected morning SOC, and the current decision explanation.

<img width="1290" height="2619" alt="Marvin control and decision logic" src="https://github.com/user-attachments/assets/d894366f-018c-4646-8a2a-edb2dfb6d925" />

### EV and grid feedback

The EV-control view showing THOR state, non-EV load, actual grid import, recommended current, limits, and forced-charge controls.

<img width="1290" height="2619" alt="Marvin EV and grid feedback" src="https://github.com/user-attachments/assets/75bfb27a-2b0c-4e37-bf2e-64c4d7f87530" />

### HVAC and diagnostics

The HVAC, data-health, grid-availability, storm-reserve, outage-test, and daily-summary controls from the running reference installation.

<img width="1290" height="2601" alt="Marvin HVAC and diagnostics" src="https://github.com/user-attachments/assets/d31e1b28-f82e-4e38-b4e4-2ebfc7d9b08b" />
